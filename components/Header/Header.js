    ...
    return(
      <View style={[styles.headerWrap, {backgroundColor: (this.props.transparent) ? 'transparent' : (this.props.headerProps.accent) ? colors.accent : (this.props.headerProps.obsidian) ? colors.obisdian : colors.richBlack}]}>
        ...
        <View style={[styles.chunkQuo, { alignItems: 'center' }]}>
          ...
          { this.props.headerProps.types.notificationsIcon ? getNotificationsIcon(this.props.headerProps.callbackNotifications, this.props.headerProps.opacity, this.props.currentUser.appFlags.numUnseenNotifications || 0) : null }
        </View>
      </View>
    );
  }
