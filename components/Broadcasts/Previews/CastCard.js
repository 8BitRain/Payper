...
class CastCard extends React.Component {
  constructor(props) {
    ...
    console.log("--> Constructing CastCard with props", props)
  ...
  componentWillReceiveProps(nextProps) {
    console.log("--> CastCard will receive props", nextProps)
  ...
  render() {
    return(
      <TouchableHighlight
        ...
        onPress={() => Actions.UnjoinedBroadcast({broadcast: this.props.broadcast, canViewCasterProfile: this.props.canViewCasterProfile})}>
