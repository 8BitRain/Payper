    ...
    return(
      <View style={{flex: 1.0, flexDirection: 'row'}}>
        <TouchableHighlight
          ...
          style={{flex: 0.5, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', backgroundColor: colors.darkGrey, borderRightColor: colors.orangeYellow, borderRightWidth: 0.5}}
          underlayColor={colors.darkGrey}
          activeOpacity={0.7}>
          <View>
            <Text style={{fontSize: 16, fontWeight: '600', color: colors.orangeYellow}}>Request</Text>
          </View>
        </TouchableHighlight>
        <TouchableHighlight
          onPress={() => this.props.payCallback()}
          style={{flex: 0.5, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', backgroundColor: colors.darkGrey, borderLeftColor: colors.orangeYellow, borderLeftWidth: 0.5}}
          underlayColor={colors.darkGrey}
          activeOpacity={0.7}>
          <View>
            <Text style={{fontSize: 16, fontWeight: '600', color: colors.orangeYellow}}>Pay</Text>
          </View>
        </TouchableHighlight>
      </View>
    );
