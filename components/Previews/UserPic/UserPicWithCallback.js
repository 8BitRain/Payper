    ...
    if (!this.props.user.profile_pic || this.props.user.profile_pic == "") {
      ...
      return(
        <View style={{width: dimensions.width, flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
          <View style={[userStyles.pic, userStyles.initials, {backgroundColor: colors.white, width: this.props.width, height: this.props.height, borderColor: (this.props.user.provider || this.props.user.username || this.props.accent) ? colors.accent : colors.icyBlue, borderRadius: this.props.width / 2}]}>
