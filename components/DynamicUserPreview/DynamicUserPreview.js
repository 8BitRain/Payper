  ...
  render() {
    return(
      <TouchableHighlight
        ...
        <Animated.View style={[styles.userWrap, { borderColor: this.state.color, borderLeftWidth: 4, width: this.props.width }]}>
          ...
          <View style={styles.textWrap}>
            ...
            <Text style={[styles.usernameText], {color: (this.props.user.username) ? colors.accent : colors.gradientGreen}}>
