...
export default class User {
  ...
  **/
  getUserWithToken(params, callback) {
    try {
      fetch("https://mey71fma7i.execute-api.us-east-1.amazonaws.com/prod/auth/get", {method: "POST", body: JSON.stringify(params)})
  ...
  **/
  getOrCreateFacebookUser(params, callback) {
    try {
      fetch("https://mey71fma7i.execute-api.us-east-1.amazonaws.com/prod/user/facebookCreate", {method: "POST", body: JSON.stringify(params)})
      .then((response) => response.json())
      .then((responseData) => callback(responseData))
      .done();
    } catch (err) {
  ...
  createUserWithEmailAndPassword(params, onSuccess, onFailure) {
    ...
    firebase.auth().createUserWithEmailAndPassword(params.email, params.password).then(() => {
      firebase.auth().currentUser.getToken(true).then((token) => {
        params.token = token;
        try {
          fetch("https://mey71fma7i.execute-api.us-east-1.amazonaws.com/prod/user/create", {method: "POST", body: JSON.stringify(params)})
          .then((response) => response.json())
          .then((responseData) => {
  ...
  **/
  createDwollaCustomer(params, onSuccess, onFailure) {
    ...
    try {
      fetch("https://mey71fma7i.execute-api.us-east-1.amazonaws.com/prod/customer/create", {method: "POST", body: JSON.stringify(params)})
      .then((response) => response.json())
      .then((responseData) => {
        if (!responseData.errorMessage) {
  ...
  **/
  getFundingSource(cb) {
    ...
    try {
      fetch("https://mey71fma7i.execute-api.us-east-1.amazonaws.com/prod/customer/getFundingSource", {method: "POST", body: JSON.stringify(params)})
      .then((response) => response.json())
      .then((responseData) => {
  ...
  **/
  decrypt(cb) {
    ...
    try {
      fetch("https://mey71fma7i.execute-api.us-east-1.amazonaws.com/prod/user/getPersonal", {method: "POST", body: JSON.stringify(params)})
      .then((response) => response.json())
      .then((responseData) => {
  ...
  **/
  getIAVToken(params, updateViaRedux) {
    try {
      fetch("https://mey71fma7i.execute-api.us-east-1.amazonaws.com/prod/utils/getIAV", {method: "POST", body: JSON.stringify(params)})
      .then((response) => response.json())
      .then((responseData) => {
        if (!responseData.errorMessage)
