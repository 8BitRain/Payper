    ...
    return(
      <TouchableHighlight
        ...
        <View style={styles.row}>
          <Entypo style={styles.icon} name={options.iconName} size={20} color={colors.orangeYellow} />
    ...
    return (
      <View style={{flex: 1, backgroundColor: colors.richBlack}}>
        ...
        <TouchableHighlight
          ...
          style={{borderBottomWidth: 0.5, borderBottomColor: colors.orangeYellow}}>

          <View style={{height: 70, marginTop: 30, paddingBottom: 12.5, paddingLeft: 20, flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: colors.orangeYellow}}>
            ...
            <View style={{flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start'}}>
              ...
              <Text style={[styles.rowTitle, {fontSize: 12, color: colors.orangeYellow, paddingLeft: 0}]}>Edit profile</Text>
            </View>
          </View>
        </TouchableHighlight>
