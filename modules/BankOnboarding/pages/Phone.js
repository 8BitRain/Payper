...
export default class Phone extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      submitText: (this.props.phone) ? "Continue" : "Please enter a valid phone number",
      validations: {
    ...
    return (
      <View style={styles.wrap}>
        ...
        <View style={{ flex: (this.props.showHeader) ? 0.85 : 1.0 }}>
          <View>
            <Text style={{ fontFamily: 'Roboto', fontSize: 24, fontWeight: '200', color: colors.deepBlue, textAlign: 'center', paddingLeft: 10, paddingRight: 10 }}>
