    ...
    return(
      <Drawer
        ...
        <View style={{flex: 1.0, backgroundColor: colors.lightGrey}}>
          ...
          { /* Header */ }
          <View style={{flexDirection: 'row', height: 60, overflow: 'hidden', zIndex: 0, borderBottomWidth: (this.state.searchBarVisible) ? 1 : 0, borderColor: colors.accent}}>
          ...
          { /* Footer */ }
          <View style={{position: 'absolute', bottom: 0, left: 0, right: 0, flexDirection: 'row', borderTopWidth: 1.0, borderColor: colors.lightGrey, backgroundColor: 'rgba(255, 255, 255, .9)', justifyContent: 'space-between'}}>
