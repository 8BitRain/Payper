...
class MainView extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    console.log("<NewMainView /> will receive nextProps", nextProps)
    ...
    return(
      <Drawer
        ...
        <View style={{flex: 1.0, backgroundColor: colors.mintCream}}>
          ...
          <Animated.View style={{height: this.animatedValues.filterMenuHeight, backgroundColor: colors.darkMintCream}}>
