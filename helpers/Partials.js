...
class UserPic extends React.Component {
  ...
  render() {
    if (!this.props.pic || this.props.pic == "") {
      ...
      return <Image style={{borderWidth: 1, borderColor: colors.accent, width: this.props.width, height: this.props.height, borderRadius: this.props.height / 2}} source={{uri: this.props.pic}} />;
    }
  }
};
