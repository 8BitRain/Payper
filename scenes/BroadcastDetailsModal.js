    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.row}>
          <View>
            <Text>
              {`$${this.props.amount} per ${formatFrequency(this.props.frequency)}`}
            </Text>
            <Text>
              {`${this.props.memberLimit - this.props.memberIDs.split(",").length} spot available`}
            </Text>
          </View>
